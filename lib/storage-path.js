...
/**
 * Validate a private applications-bucket path belongs to userId.
 * Returns null if ok, or an error string.
 */
export function assertOwnedApplicationsPath(rawPath, userId, label = "Document") {
  ...
  if (!isOwnerStoragePath(sanitized.path, userId)) {
    return `${label} must be uploaded under your account`;
  }
  return null;
}
