...
/**
 * emailRedirectTo for signUp / resend when Confirm signup template still uses
 * ConfirmationURL. Prefer TokenHash template pointing at /auth/confirm.
 * @param {string} [originFallback]
 */
export function applicantEmailConfirmRedirectTo(originFallback = "") {
  return applicantEmailConfirmBaseUrl(originFallback);
}
